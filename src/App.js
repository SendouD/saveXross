  ...
  return(
    <>
      <Routes>
        ...
        <ProtectedRoute isAuthenticated={ckverifer} path="/verifier" element={<Verifier blueAddress = {blueAddress} stakeAddress={stakeAddress} rewardAddress={rewardAddress}/>}/>
        <ProtectedRoute isAuthenticated={ckowner} path="/admin" element={<Admin blueAddress = {blueAddress} stakeAddress={stakeAddress} rewardAddress={rewardAddress}/>}/>
